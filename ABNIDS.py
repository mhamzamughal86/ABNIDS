...
from PyQt5.QtWidgets import qApp,QFileDialog,QMessageBox,QMainWindow,QDialog,QDialogButtonBox,QVBoxLayout, QHeaderView
import os
import time
...
class Ui_MainWindow(object):
    ...
    def train_model(self):
        try:
            ...
            if train_dataset:
                ...
                test_dataset, test_dataset_type = QFileDialog.getOpenFileName(MainWindow, "Select Testint Dataset","","All Files (*);;CSV Files (*.csv)")
            if train_dataset and test_dataset:
                generation  = 0
                # train_dataset = data.Dataset.refine_dataset(train_dataset, "Train Dataset.txt")
                
                # test_dataset = data.Dataset.refine_dataset(test_dataset, "Test Dataset.txt")s
                ...
                while(ga.population.max_fitness<93 and generation<5):
            ...
            for packet in capture.sniff_continuously():
                try:
                    if "<UDP Layer>" in str(packet.layers) and "<IP Layer>" in str(packet.layers):
                        attr_list = self.packet.udp_packet_attributes(packet)
    ...
    def setupUi(self, MainWindow):
        ...
        # Buttons
        # icon = QtGui.QIcon()
        # icon.addPixmap(QtGui.QPixmap("start-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.btn_start.setIcon(icon)
        # self.btn_start.setIconSize(QtCore.QSize(50, 40))
        ...
        # icon1 = QtGui.QIcon()
        # icon1.addPixmap(QtGui.QPixmap("Button_5-512.webp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.btn_pause.setIcon(icon1)
        # self.btn_pause.setIconSize(QtCore.QSize(50, 40))
        ...
        # icon2 = QtGui.QIcon()
        # icon2.addPixmap(QtGui.QPixmap("database-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.btn_modeltrain.setIcon(icon2)
        # self.btn_modeltrain.setIconSize(QtCore.QSize(50, 50))
        ...
        # icon3 = QtGui.QIcon()
        # icon3.addPixmap(QtGui.QPixmap("73-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.btn_statictesting.setIcon(icon3)
        # self.btn_statictesting.setIconSize(QtCore.QSize(50, 50))
        ...
        self.btn_realtimetesting.setText("Realtime Texting")
        
        # icon4 = QtGui.QIcon()
        # icon4.addPixmap(QtGui.QPixmap("24141.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.btn_realtimetesting.setIcon(icon4)
        # self.btn_realtimetesting.setIconSize(QtCore.QSize(50, 50))
        ...
        icon5 = QtGui.QIcon()
        # icon5.addPixmap(QtGui.QPixmap("blue-green-save-icon-1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.btn_savelog.setIcon(icon5)
        # self.btn_savelog.setIconSize(QtCore.QSize(50, 50))
        ...
        # icon6 = QtGui.QIcon()
        # icon6.addPixmap(QtGui.QPixmap("arrow-bar-chart-icon--17.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.btn_graph.setIcon(icon6)
        # self.btn_graph.setIconSize(QtCore.QSize(50, 50))
        ...
        # icon7 = QtGui.QIcon()
        # icon7.addPixmap(QtGui.QPixmap("exit-png-exit-icon-png-close-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(r"C:\Users\Hamza\Desktop\abnids\icons\asd.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_start.setStatusTip(_translate("MainWindow", "Start"))
        self.btn_pause.setStatusTip(_translate("MainWindow", "Pause"))
